...
const Icon4SquareFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="4-square-fill" {...restProps} ref={ref}>
...
Icon4SquareFill.displayName = 'Icon4SquareFill';
