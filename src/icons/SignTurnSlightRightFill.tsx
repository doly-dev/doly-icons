...
const SignTurnSlightRightFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="sign-turn-slight-right-fill" {...restProps} ref={ref}>
...
SignTurnSlightRightFill.displayName = 'SignTurnSlightRightFill';
