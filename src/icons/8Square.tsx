...
const Icon8Square = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="8-square" {...restProps} ref={ref}>
...
Icon8Square.displayName = 'Icon8Square';
