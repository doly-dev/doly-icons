...
const DuffleFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="duffle-fill" {...restProps} ref={ref}>
...
DuffleFill.displayName = 'DuffleFill';
