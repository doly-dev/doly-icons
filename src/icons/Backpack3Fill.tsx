...
const Backpack3Fill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="backpack3-fill" {...restProps} ref={ref}>
...
Backpack3Fill.displayName = 'Backpack3Fill';
