...
const FastForwardCircleFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="fast-forward-circle-fill" {...restProps} ref={ref}>
