...
const EnvelopePaperHeartFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="envelope-paper-heart-fill" {...restProps} ref={ref}>
