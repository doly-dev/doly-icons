...
const EmojiTear = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="emoji-tear" {...restProps} ref={ref}>
...
EmojiTear.displayName = 'EmojiTear';
