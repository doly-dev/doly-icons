...
const Icon8Circle = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="8-circle" {...restProps} ref={ref}>
...
Icon8Circle.displayName = 'Icon8Circle';
