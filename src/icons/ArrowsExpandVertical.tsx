...
const ArrowsExpandVertical = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="arrows-expand-vertical" {...restProps} ref={ref}>
...
ArrowsExpandVertical.displayName = 'ArrowsExpandVertical';
