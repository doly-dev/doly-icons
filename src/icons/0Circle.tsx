...
const Icon0Circle = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="0-circle" {...restProps} ref={ref}>
...
Icon0Circle.displayName = 'Icon0Circle';
