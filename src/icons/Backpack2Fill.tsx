...
const Backpack2Fill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="backpack2-fill" {...restProps} ref={ref}>
...
Backpack2Fill.displayName = 'Backpack2Fill';
