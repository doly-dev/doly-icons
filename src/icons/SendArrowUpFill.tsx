...
const SendArrowUpFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="send-arrow-up-fill" {...restProps} ref={ref}>
...
SendArrowUpFill.displayName = 'SendArrowUpFill';
