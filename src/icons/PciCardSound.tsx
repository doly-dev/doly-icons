...
const PciCardSound = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="pci-card-sound" {...restProps} ref={ref}>
...
PciCardSound.displayName = 'PciCardSound';
