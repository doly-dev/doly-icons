...
const Icon5CircleFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="5-circle-fill" {...restProps} ref={ref}>
...
Icon5CircleFill.displayName = 'Icon5CircleFill';
