...
const PSquareFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="p-square-fill" {...restProps} ref={ref}>
...
PSquareFill.displayName = 'PSquareFill';
