...
const Icon9Circle = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="9-circle" {...restProps} ref={ref}>
...
Icon9Circle.displayName = 'Icon9Circle';
