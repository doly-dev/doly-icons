...
const SignMergeRightFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="sign-merge-right-fill" {...restProps} ref={ref}>
...
SignMergeRightFill.displayName = 'SignMergeRightFill';
