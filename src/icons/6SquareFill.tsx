...
const Icon6SquareFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="6-square-fill" {...restProps} ref={ref}>
...
Icon6SquareFill.displayName = 'Icon6SquareFill';
