...
const Icon8CircleFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="8-circle-fill" {...restProps} ref={ref}>
...
Icon8CircleFill.displayName = 'Icon8CircleFill';
