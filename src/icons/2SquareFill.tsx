...
const Icon2SquareFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="2-square-fill" {...restProps} ref={ref}>
...
Icon2SquareFill.displayName = 'Icon2SquareFill';
