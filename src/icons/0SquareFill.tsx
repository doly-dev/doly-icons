...
const Icon0SquareFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="0-square-fill" {...restProps} ref={ref}>
...
Icon0SquareFill.displayName = 'Icon0SquareFill';
