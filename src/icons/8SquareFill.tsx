...
const Icon8SquareFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="8-square-fill" {...restProps} ref={ref}>
...
Icon8SquareFill.displayName = 'Icon8SquareFill';
