...
const PersonWheelchair = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="person-wheelchair" {...restProps} ref={ref}>
...
PersonWheelchair.displayName = 'PersonWheelchair';
