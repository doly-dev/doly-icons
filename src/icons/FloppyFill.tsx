...
const FloppyFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="floppy-fill" {...restProps} ref={ref}>
...
FloppyFill.displayName = 'FloppyFill';
