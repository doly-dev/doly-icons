...
const Icon9SquareFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="9-square-fill" {...restProps} ref={ref}>
...
Icon9SquareFill.displayName = 'Icon9SquareFill';
