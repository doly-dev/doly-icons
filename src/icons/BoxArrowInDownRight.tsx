...
const BoxArrowInDownRight = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="box-arrow-in-down-right" {...restProps} ref={ref}>
