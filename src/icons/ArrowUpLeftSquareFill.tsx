...
const ArrowUpLeftSquareFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="arrow-up-left-square-fill" {...restProps} ref={ref}>
