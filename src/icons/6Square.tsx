...
const Icon6Square = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="6-square" {...restProps} ref={ref}>
...
Icon6Square.displayName = 'Icon6Square';
