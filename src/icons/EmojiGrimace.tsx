...
const EmojiGrimace = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="emoji-grimace" {...restProps} ref={ref}>
...
EmojiGrimace.displayName = 'EmojiGrimace';
