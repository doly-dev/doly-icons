...
const EnvelopeArrowDown = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="envelope-arrow-down" {...restProps} ref={ref}>
...
EnvelopeArrowDown.displayName = 'EnvelopeArrowDown';
