...
const Icon5SquareFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="5-square-fill" {...restProps} ref={ref}>
...
Icon5SquareFill.displayName = 'Icon5SquareFill';
