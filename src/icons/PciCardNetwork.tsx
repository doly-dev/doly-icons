...
const PciCardNetwork = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="pci-card-network" {...restProps} ref={ref}>
...
PciCardNetwork.displayName = 'PciCardNetwork';
