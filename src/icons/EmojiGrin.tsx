...
const EmojiGrin = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="emoji-grin" {...restProps} ref={ref}>
...
EmojiGrin.displayName = 'EmojiGrin';
