...
const MailboxFlag = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="mailbox-flag" {...restProps} ref={ref}>
...
MailboxFlag.displayName = 'MailboxFlag';
