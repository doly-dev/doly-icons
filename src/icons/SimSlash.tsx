...
const SimSlash = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="sim-slash" {...restProps} ref={ref}>
