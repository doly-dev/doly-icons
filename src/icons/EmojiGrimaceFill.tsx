...
const EmojiGrimaceFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="emoji-grimace-fill" {...restProps} ref={ref}>
...
EmojiGrimaceFill.displayName = 'EmojiGrimaceFill';
