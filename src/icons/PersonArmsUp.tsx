...
const PersonArmsUp = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="person-arms-up" {...restProps} ref={ref}>
...
PersonArmsUp.displayName = 'PersonArmsUp';
