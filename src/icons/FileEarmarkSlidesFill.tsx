...
const FileEarmarkSlidesFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="file-earmark-slides-fill" {...restProps} ref={ref}>
