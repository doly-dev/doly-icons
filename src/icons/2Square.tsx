...
const Icon2Square = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="2-square" {...restProps} ref={ref}>
...
Icon2Square.displayName = 'Icon2Square';
