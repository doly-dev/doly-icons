...
const EmojiAstonishedFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="emoji-astonished-fill" {...restProps} ref={ref}>
...
EmojiAstonishedFill.displayName = 'EmojiAstonishedFill';
