...
const EnvelopeArrowUpFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="envelope-arrow-up-fill" {...restProps} ref={ref}>
...
EnvelopeArrowUpFill.displayName = 'EnvelopeArrowUpFill';
