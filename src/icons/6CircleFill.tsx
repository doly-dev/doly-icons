...
const Icon6CircleFill = forwardRef<HTMLSpanElement, IconBaseProps>(({ svgProps, ...restProps }, ref) => {
  return (
    <IconBase aria-label="6-circle-fill" {...restProps} ref={ref}>
...
Icon6CircleFill.displayName = 'Icon6CircleFill';
